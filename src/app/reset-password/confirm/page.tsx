...
export default function ResetPasswordConfirmPage() {
  ...
  useEffect(() => {
    // URL ハッシュに access_token が含まれているかチェック
  ...
  if (!validToken) {
    return (
      <div className="h-[100dvh] overflow-hidden bg-slate-100 flex items-center justify-center px-5">
        <div className="bg-white rounded-2xl border border-slate-200 shadow-md p-8 max-w-sm w-full text-center">
          <p className="text-lg font-bold text-slate-900 mb-2">リンクを確認中...</p>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-md overflow-hidden">
            ...
            {done ? (
              <div className="px-6 py-8 text-center">
                ...
                <p className="text-lg font-bold text-slate-900">変更完了しました</p>
                <p className="text-slate-500 text-base mt-1">ログイン画面に移動します…</p>
              </div>
            ) : (
              <form onSubmit={submit} className="px-6 py-5 flex flex-col gap-4">
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-3 pr-14 rounded-xl border-2 border-slate-300 text-slate-900 focus:outline-none focus:border-slate-600 transition-colors"
                      style={{ fontSize: '16px' }}
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border-2 border-slate-300 text-slate-900 focus:outline-none focus:border-slate-600 transition-colors"
                    style={{ fontSize: '16px' }}
                    autoComplete="new-password"
                  />
