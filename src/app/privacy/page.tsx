...
export default function PrivacyPage() {
  return (
    <div className="max-w-2xl mx-auto px-5 py-10">
      ...
      <p className="text-sm text-slate-500 mb-8">制定：2026年1月1日　最終更新：2026年6月3日</p>
      ...
      <div className="space-y-8 text-base text-slate-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-bold text-slate-900 mb-3">第1条　収集する情報</h2>
        ...
        <section>
          <h2 className="text-lg font-bold text-slate-900 mb-3">第2条　利用目的</h2>
          ...
          <p className="mt-3 text-slate-600">上記以外の目的で個人情報を利用する場合は、事前にユーザーの同意を得るものとします。</p>
        </section>

        <section>
          <h2 className="text-lg font-bold text-slate-900 mb-3">第3条　データの保管・管理</h2>
        ...
        <section>
          <h2 className="text-lg font-bold text-slate-900 mb-3">第4条　第三者への提供・共有</h2>
          ...
          <p className="mt-3 text-slate-600">本サービスは、サービス提供のためSupabase（インフラ）を利用しています。これらは業務委託先であり、必要最小限の情報のみを取り扱います。</p>
        </section>

        <section>
          <h2 className="text-lg font-bold text-slate-900 mb-3">第5条　Cookie・ローカルストレージの使用</h2>
          ...
          <p className="mt-3 text-slate-600">広告目的のCookieや第三者トラッキングCookieは使用しません。</p>
        </section>

        <section>
          <h2 className="text-lg font-bold text-slate-900 mb-3">第6条　データの保持期間</h2>
          <ul className="list-disc list-inside space-y-1.5 text-slate-600 pl-2">
        ...
        <section>
          <h2 className="text-lg font-bold text-slate-900 mb-3">第7条　ユーザーの権利</h2>
          ...
          <p className="mt-3 text-slate-600">権利行使をご希望の場合は、下記お問い合わせ先までご連絡ください。</p>
        </section>

        <section>
          <h2 className="text-lg font-bold text-slate-900 mb-3">第8条　セキュリティ</h2>
          <ul className="list-disc list-inside space-y-1.5 text-slate-600 pl-2">
          ...
          <p className="mt-3 text-slate-600">セキュリティインシデントを発見した場合は、72時間以内にユーザーへ通知します。</p>
        </section>

        <section>
          <h2 className="text-lg font-bold text-slate-900 mb-3">第9条　未成年者の利用</h2>
          <p>本サービスは事業者向けのBtoBサービスであり、18歳未満の方の個人利用は想定しておりません。18歳未満の方が利用していることが判明した場合は、アカウントを停止することがあります。</p>
        </section>

        <section>
          <h2 className="text-lg font-bold text-slate-900 mb-3">第10条　ポリシーの変更</h2>
          <p>本ポリシーを変更する場合は、変更後のポリシーを本ページに掲載するとともに、重要な変更の場合はメールで事前通知します。変更後も本サービスを継続利用した場合は、変更後のポリシーに同意したものとみなします。</p>
        </section>

        <section>
          <h2 className="text-lg font-bold text-slate-900 mb-3">第11条　準拠法・管轄裁判所</h2>
          <p>本ポリシーは日本法に準拠します。本ポリシーに関する紛争については、東京地方裁判所を第一審の専属的合意管轄裁判所とします。</p>
        </section>

        <section>
          <h2 className="text-lg font-bold text-slate-900 mb-3">第12条　お問い合わせ</h2>
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 text-slate-600">
            <p className="font-bold text-slate-800 mb-1">ParkLedger サポート窓口</p>
            <p>受付時間：平日 9:00〜18:00</p>
            <p className="mt-1 text-sm text-slate-500">※ アプリ内の問い合わせフォームからもお問い合わせいただけます。</p>
          </div>
        </section>
      ...
      <div className="mt-12 pt-6 border-t border-slate-200 flex items-center justify-between">
        <Link href="/login" className="text-slate-500 hover:text-slate-800 text-sm underline underline-offset-2">← ログインに戻る</Link>
        <p className="text-xs text-slate-400">ParkLedger © 2026</p>
      </div>
    </div>
  );
}
