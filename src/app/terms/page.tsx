  ...
  return (
    <div className="max-w-2xl mx-auto px-5 py-10">
      ...
      <div className="space-y-8 text-base text-slate-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-bold text-slate-900 mb-3">第2条　アカウント</h2>
        ...
        <section>
          <h2 className="text-lg font-bold text-slate-900 mb-3">第4条　サービスの提供・変更・停止</h2>
          <ol className="list-decimal list-inside space-y-2 text-slate-600 pl-2">
        ...
        <section>
          <h2 className="text-lg font-bold text-slate-900 mb-3">第5条　データの取り扱い</h2>
          <ol className="list-decimal list-inside space-y-2 text-slate-600 pl-2">
        ...
        <section>
          <h2 className="text-lg font-bold text-slate-900 mb-3">第6条　知的財産権</h2>
        ...
        <section>
          <h2 className="text-lg font-bold text-slate-900 mb-3">第8条　アカウントの停止・解除</h2>
        ...
        <section>
          <h2 className="text-lg font-bold text-slate-900 mb-3">第9条　規約の変更</h2>
          <p>重要な変更の場合は30日前までにメールで通知します。変更後も継続利用した場合は変更後の規約に同意したものとみなします。</p>
        </section>

        <section>
          <h2 className="text-lg font-bold text-slate-900 mb-3">第10条　準拠法・管轄</h2>
          <p>本規約は日本法に準拠します。紛争については東京地方裁判所を第一審の専属的合意管轄裁判所とします。</p>
        </section>

        <section>
          <h2 className="text-lg font-bold text-slate-900 mb-3">第11条　お問い合わせ</h2>
          <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 text-slate-600">
            <p className="font-bold text-slate-800 mb-1">ParkLedger 運営事務局</p>
            <p className="text-sm text-slate-500">お問い合わせはアプリ内のフォームよりお願いします。</p>
          </div>
        </section>
